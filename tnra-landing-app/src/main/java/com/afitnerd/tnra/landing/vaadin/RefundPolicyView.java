...
/**
 * Standalone Refund Policy page. Content lives in src/main/resources/content/refund-policy.md and is
 * also embedded (as a section) on {@link FinePrintView}.
 */
@Route("refund-policy")
@PageTitle("Refund Policy — TNRA")
@AnonymousAllowed
@CssImport("./styles/theme.css")
@CssImport("./styles/landing-view.css")
public class RefundPolicyView extends VerticalLayout implements AfterNavigationObserver {

    static final String CONTENT_RESOURCE = "/content/refund-policy.md";

    public RefundPolicyView(MarkdownService markdownService, LandingContentRenderer renderer) {
