...
network as `tnra-billing`; only nginx publishes it externally):
...
Build and start it (from `~/tnra/`, after copying the repo / pulling latest):
...
### Step 5: Nginx route for `billing.tnra.app`
